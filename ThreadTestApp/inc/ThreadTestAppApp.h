#ifndef _THREAD_TEST_APP_APP_H_
#define _THREAD_TEST_APP_APP_H_
...
//  The [ThreadTestApp]App class must inherit from the UiApp class,
//  which provides the basic features necessary to define a UI application.
 
class ThreadTestAppApp
...
public:
	...
	ThreadTestAppApp(void);
	virtual ~ThreadTestAppApp(void);
